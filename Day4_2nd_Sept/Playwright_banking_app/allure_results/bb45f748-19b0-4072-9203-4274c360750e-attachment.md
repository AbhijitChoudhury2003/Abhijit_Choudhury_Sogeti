...
> 13 |         .fill(bankingData.login.username);
  ...
  49 |  
  50 |     await transferPage.selectFromAccount(transfer.fromAccount);
  51 |  
  52 |     await transferPage.selectToAccount(transfer.toAccount);
  53 |  
  54 |     await transferPage.enterTransferAmount(transfer.amount);
  55 |  
  56 |     await transferPage.executeTransfer();
  57 | });
  58 |  
  59 |  
```